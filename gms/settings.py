...
SECRET_KEY = 'django-insecure-djb^l89y5rjr49#!cf9tykm%0z$8iedz_c0!7xr7oz=l-sc9ei'
...
# Where your static files live (development)
STATICFILES_DIRS = [
    BASE_DIR  / 'static',
]

# Where collectstatic will copy files to (REQUIRED)
